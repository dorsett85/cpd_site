    ...
    <div>
        ...
        <div id="headerText" class="d-block text-center">
            <div data-aos="zoom-out-right" data-aos-delay="1000" data-aos-duration="1500">
                <span class="d-block p-1 headTxtHvr"><i class="fas fa-chart-bar"></i> Visualization</span>
            </div>
            <div data-aos="zoom-out-left" data-aos-delay="1200" data-aos-duration="1500">
                <span class="d-block p-1 headTxtHvr"><i class="fab fa-connectdevelop"></i> Web Development</span>
            </div>
            <div data-aos="zoom-out-right" data-aos-delay="1400" data-aos-duration="1500">
                <span class="d-block p-1 headTxtHvr"><i class="far fa-file-code"></i> Data Programming</span>
            </div>
        </div>
    </div>
</header>
